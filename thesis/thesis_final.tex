...
%%        \includegraphics[clip, trim=1cm 1cm 1cm 1cm,scale=0.3]{./Plots/normal/a77.pdf}
%        \includegraphics[clip, trim=2cm 3cm 2cm 4cm,scale=0.48]{./Plots/normal/a77_1.pdf}
%     }
%     \vfill
     \subfloat[\label{subfig-2:radial}]{
       \includegraphics[scale=.48]{./Plots/normal/v.png}
     }
     \vfill
     \subfloat[\label{subfig-1:radial2}]{%
        \includegraphics[scale=0.6]{./Plots/normal/compositematerials.png}
     }
...
\begin{center}
     ...
     \subfloat[\label{subfig-2:extreme2}]{
        \includegraphics[clip, trim=1cm 1cm 1cm 1cm, scale=0.33]{./Plots/height/height.pdf}
     }
    \label{fig:height}
    ...
    \begin{tabular}{@{}c}
        ...
        0.0477&    0.0547&         0\\
         0&         0&    0.0608
           \end{bmatrix}}$
    \end{tabular}
    \caption{(a) Optimized base cell, (b) 3x3 arrangement of the base cell, (c) $D^H$ matrix of the base cell for Cantilever beam of L=40, H=20 starting with design 2}
    \label{fig:cant2}
\end{center}
\end{figure}
%\begin{figure}[H]
