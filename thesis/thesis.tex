...
In the previous chapter, we showed that bamboo has optimal one dimensional distribution of the given material for the some constraints. In this chapter, we will discuss the development of 2D topology optimization code required for the generating optimal two dimensional structures from the given materials. 
