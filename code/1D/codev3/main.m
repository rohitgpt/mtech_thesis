...
E2 = 4.25*10^9;
    ...
    [M, y_inv, min_x, max_x, x] = Problem(n,  r1, r2, cur, sigma, M_min);

    options = optimoptions('fmincon','Algorithm','interior-point');
    `
    options.MaxFunEvals = 100000;
    options.MaxIter=2000;
    options.OptimalityTolerance = 9e-6;
%     options.StepTolerance=1e-500 ;
...
%%%       cur*M_min/(dr*pi)
        ...
        saveas(gcf, sprintf('l%d%d.jpg', i, j), 'jpeg');
        pause(0.1);
        hold off;
    end
        end
